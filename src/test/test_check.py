...
class TestCheck(unittest.TestCase):
    ...
    def test_new_version_on_weather_change(self):
        with patch('requests.get') as mock_request:
            ...
            versions = run_check(self.tokyo, Version("cloudy", ""))
    ...
    def test_no_version_on_same_weather(self):
        with patch('requests.get') as mock_request:
            ...
            versions = run_check(self.tokyo, Version("sunny", ""))
    ...
    def test_new_version_when_previous_empty(self):
        with patch('requests.get') as mock_request:
            ...
            versions = run_check(self.tokyo, EmptyVersion())
